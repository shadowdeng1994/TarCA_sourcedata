...
def read_tip(fate_map_id):
    path_map = path + "tip_population_size\\tip_pop_size_fate_map" + str(fate_map_id).rjust(4, '0') + ".csv"
...
if __name__ == "__main__":
    path_fix = path + "merge_population_size_bias\\fixed\\"
    path_prop = path + "merge_population_size_bias\\proportional\\"
    fate_map_fix = {}
    for i in range(331):
